...
{
    public partial class perfect_weight_result : Form
    {
        perfect_weight B = new perfect_weight();


        public perfect_weight_result()
        {
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            textBox2.Text = (best_weight.ToString());
            textBox1.Text = (min_best_weight + " _ " + max_best_weight.ToString());
